...
c----------------------------------------------------------------------
c
	subroutine getgenes(code1,chainid1,code2,chainid2,d1,d2,nres1,nres2,
     $		blocksize,ngene,genepool,lpreali,preali1)
	implicit none
...
c	hash proteins
c
	call getprotein1(code1,chainid1,nres1,d1,blocksize,
     $		dist1,distoverlay1,hash1)
	call getprotein2(code1,chainid1,nres1,d1,blocksize,
     $		hash1,lhash1)
	call getprotein1(code2,chainid2,nres2,d2,blocksize,
...
c	end do
	call getprotein2(code2,chainid2,nres2,d2,blocksize,hash2,lhash2)
	ngene2=0
