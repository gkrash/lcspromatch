...
c
	...
	real score(popsize)
c
	integer left(maxres),rite(maxres),ali(maxres),table0(maxres,maxres)
	integer table(maxres,maxres),newscore
...
c
	integer left(maxres),rite(maxres),ali(maxres),table0(maxres,maxres)
	integer i,niter,newscore,oldscore
c
	oldscore=-9
	newscore=0
	niter=0
	...
	do while((newscore.gt.oldscore).and.(niter.lt.10))
		...
		oldscore=newscore
		call getleftrite(nres1,nres2,preali1,left,rite,10)
		call filltable0(table0,left,rite,preali1,nres1,nres2,d1,d2)
		call nw(nres1,nres2,table0,newscore,ali)
		do i=1,nres1
			preali1(i)=ali(i)
		end do
...
c------------------------------------------------------------------------------
c
	subroutine filltable0(table0,left,rite,preali1,nres1,nres2,d1,d2)
	implicit none
	include 'gagasizes.for'
	integer nres1,nres2
