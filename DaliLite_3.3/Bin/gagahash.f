...
c----------------------------------------------------------------------
c
	subroutine getprotein2(code,chainid,nres,d,blocksize,
     $		hash,lsearch)
	implicit none
...
c
	...
	call segments(psquare,nres,d,blocksize,nseg,segtype,segfirst,seglast)
...
c----------------------------------------------------------------------
c
	subroutine getprotein1(code,chainid,nres,d,blocksize,
...
c----------------------------------------------------------------------
c
	subroutine partitionchain(psquare,segfirst,seglast,lsearch,blocksize,
     $		nseg,nres)
	implicit none
	include 'gagasizes.for'
	integer*2 psquare(maxres,maxres)
...
c	segments are square-blocks
	call getsegments(map,nres-blocksize+1,nseg,segtype,segfirst,seglast)
