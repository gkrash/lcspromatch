...
29	end if
	write(*,*),'preali1 done',k,(tsil(j),j=1,nres1),(tsil2(j),j=1,nres2)
c
...
c		fitz iterations
		call fitz(ca1,nres1,ca2,nres2,ali,fitzrcut,fitzmaxiter,rms,nali,niter)
...
!			write(*,*) 'fitz result ',i,ali(i),preali1(i)
			...
			write(*,*) 'fitzed preali1',rms,nali,niter,(preali1(i),i=1,nres1)
		end if
	end if
c
...
c	else if(lpreali) then
	    ...
	    if(ntetra.gt.0) call lean_mc(50,4,nres1,nres2,d1,d2,.true.,preali1,
     $		itrim(2),score,ali1,ntetra,tetrapool)
	    write(*,*),'lean_mc done'
c
...
c
	    write(*,*) 'call output'
	    call output(code1,chainid1,code2,chainid2,nres1,nres2,seq1,seq2,
     $		struc1,struc2,resno1,resno2,1,hdr1,hdr2,ca1,ca2,
...
!	    write(*,*),'output: ',code1,chainid1,code2,chainid2,nres1,nres2
	    call output(code1,chainid1,code2,chainid2,nres1,nres2,seq1,seq2,
     $		struc1,struc2,resno1,resno2,outblocksize,hdr1,hdr2,ca1,ca2,
     $		relacc1,relacc2,d1,d2,ali1,score,nres0,tsil,nres02,tsil2)
	end do
210	ltop=ltop0
	goto 10
...
c
	write(*,*),'this is compresspreali ',nres1,nres2,nres0,maxres,maxres0
	do i=1,maxres0
		list(i)=0
		list2(i)=0
		tmp(i)=0
